...
/**
 * Inventory Service Implemetation responsible for returning product and sku inventory information.
 */
@Component
public class DefaultInventoryService implements InventoryService {

    @Autowired
    private acmeshoes.service.inventory.service.InventoryReposervice inv;
