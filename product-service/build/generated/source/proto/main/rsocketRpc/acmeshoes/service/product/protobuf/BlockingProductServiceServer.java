...
@javax.inject.Named(
    value ="BlockingProductServiceServer")
public final class BlockingProductServiceServer extends io.rsocket.rpc.AbstractRSocketService {
  private final BlockingProductService service;
  private final reactor.core.scheduler.Scheduler scheduler;
  private final java.util.function.Function<? super org.reactivestreams.Publisher<io.rsocket.Payload>, ? extends org.reactivestreams.Publisher<io.rsocket.Payload>> getProductInfo;
  @javax.inject.Inject
  public BlockingProductServiceServer(BlockingProductService service, java.util.Optional<reactor.core.scheduler.Scheduler> scheduler, java.util.Optional<io.micrometer.core.instrument.MeterRegistry> registry) {
    ...
    if (!registry.isPresent()) {
      ...
      this.getProductInfo = io.rsocket.rpc.metrics.Metrics.timed(registry.get(), "rsocket.server", "service", BlockingProductService.SERVICE_ID, "method", BlockingProductService.METHOD_GET_PRODUCT_INFO);
    }
  ...
  public String getService() {
    return BlockingProductService.SERVICE_ID;
  }
  ...
  public reactor.core.publisher.Mono<io.rsocket.Payload> requestResponse(io.rsocket.Payload payload) {
    try {
      ...
      switch(io.rsocket.rpc.frames.Metadata.getMethod(metadata)) {
        case ProductService.METHOD_GET_PRODUCT_INFO: {
          com.google.protobuf.CodedInputStream is = com.google.protobuf.CodedInputStream.newInstance(payload.getData());
          acmeshoes.service.product.protobuf.ProductInfoRequest message = acmeshoes.service.product.protobuf.ProductInfoRequest.parseFrom(is);
          return reactor.core.publisher.Mono.fromSupplier(() -> service.getProductInfo(message, metadata)).map(serializer).transform(getProductInfo).subscribeOn(scheduler);
        }
        default: {
