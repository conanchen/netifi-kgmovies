...
import acmeshoes.service.product.service.ProductReposervice;
import io.netty.buffer.ByteBuf;
import reactor.core.publisher.Mono;

/**
 * Product Service implmentation responsible for returning product information.
 */
@Component
public class DefaultProductService implements ProductService {

    @Autowired
    private ProductReposervice ps;
        ...
        return ps.getProduct(message.getProductId())
                .map(productInfo -> {
                    ...
                    return ProductInfoResponse.newBuilder()
                            ...
                            .setDescription(String.format("%s From %s",productInfo.getDescription(),DefaultProductService.class.getName()))
                            .addAllSkus(skuInfos)
                            .build();
                });
    }
