...
public class AddAssigneesToAssignableInputGQO {
    ...
    public AddAssigneesToAssignableInputGQO() {
    }

    public AddAssigneesToAssignableInputGQO(String assignableId, Collection<String> assigneeIds, String clientMutationId) {
