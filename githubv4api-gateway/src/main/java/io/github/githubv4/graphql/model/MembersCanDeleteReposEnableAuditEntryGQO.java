...
public class MembersCanDeleteReposEnableAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, EnterpriseAuditEntryDataGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    public MembersCanDeleteReposEnableAuditEntryGQO() {
    }
