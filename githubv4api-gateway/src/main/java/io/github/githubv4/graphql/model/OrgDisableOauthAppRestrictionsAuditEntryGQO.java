...
public class OrgDisableOauthAppRestrictionsAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    public OrgDisableOauthAppRestrictionsAuditEntryGQO() {
    }
