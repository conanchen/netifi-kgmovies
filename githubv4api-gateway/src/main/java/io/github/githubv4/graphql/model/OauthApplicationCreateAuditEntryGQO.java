...
public class OauthApplicationCreateAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OauthApplicationAuditEntryDataGQO, OrganizationAuditEntryDataGQO{
    ...
    private OauthApplicationCreateAuditEntryStateGQO state;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OauthApplicationCreateAuditEntryGQO() {
    }

    public OauthApplicationCreateAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String applicationUrl, String callbackUrl, String createdAt, String id, String oauthApplicationName, String oauthApplicationResourcePath, String oauthApplicationUrl, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, Integer rateLimit, OauthApplicationCreateAuditEntryStateGQO state, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OauthApplicationCreateAuditEntryStateGQO getState() {
        return state;
    }
    public void setState(OauthApplicationCreateAuditEntryStateGQO state) {
        this.state = state;
    }
