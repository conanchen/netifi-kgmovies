...
public class GpgSignatureGQO implements GitSignatureGQO{
    ...
    public GpgSignatureGQO() {
    }

    public GpgSignatureGQO(String email, Boolean isValid, String keyId, String payload, String signature, UserGQO signer, GitSignatureStateGQO state, Boolean wasSignedByGitHub) {
        this.email = email;
