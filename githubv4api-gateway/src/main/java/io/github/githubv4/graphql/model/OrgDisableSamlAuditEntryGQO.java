...
public class OrgDisableSamlAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    public OrgDisableSamlAuditEntryGQO() {
    }
