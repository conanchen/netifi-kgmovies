...
public class PrivateRepositoryForkingDisableAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, EnterpriseAuditEntryDataGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    public PrivateRepositoryForkingDisableAuditEntryGQO() {
    }

    public PrivateRepositoryForkingDisableAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String enterpriseResourcePath, String enterpriseSlug, String enterpriseUrl, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
