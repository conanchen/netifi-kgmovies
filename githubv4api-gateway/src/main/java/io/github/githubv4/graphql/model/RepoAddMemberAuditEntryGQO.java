...
public class RepoAddMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private RepoAddMemberAuditEntryVisibilityGQO visibility;

    public RepoAddMemberAuditEntryGQO() {
    }

    public RepoAddMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, RepoAddMemberAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoAddMemberAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoAddMemberAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
