...
public class RepoRemoveMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private RepoRemoveMemberAuditEntryVisibilityGQO visibility;

    public RepoRemoveMemberAuditEntryGQO() {
    }

    public RepoRemoveMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, RepoRemoveMemberAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoRemoveMemberAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoRemoveMemberAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
