...
public class OrgRemoveBillingManagerAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private OrgRemoveBillingManagerAuditEntryReasonGQO reason;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgRemoveBillingManagerAuditEntryGQO() {
    }

    public OrgRemoveBillingManagerAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgRemoveBillingManagerAuditEntryReasonGQO reason, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgRemoveBillingManagerAuditEntryReasonGQO getReason() {
        return reason;
    }
    public void setReason(OrgRemoveBillingManagerAuditEntryReasonGQO reason) {
        this.reason = reason;
    }
