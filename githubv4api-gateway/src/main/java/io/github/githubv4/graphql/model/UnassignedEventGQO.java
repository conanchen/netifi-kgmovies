...
public class UnassignedEventGQO implements IssueTimelineItemGQO, IssueTimelineItemsGQO, PullRequestTimelineItemGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public UnassignedEventGQO() {
    }

    public UnassignedEventGQO(ActorGQO actor, AssignableGQO assignable, AssigneeGQO assignee, java.util.Date createdAt, String id, UserGQO user) {
        this.actor = actor;
