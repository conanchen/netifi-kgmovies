...
public class OrgCreateAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private OrgCreateAuditEntryBillingPlanGQO billingPlan;
    @javax.validation.constraints.NotNull
    ...
    public OrgCreateAuditEntryGQO() {
    }

    public OrgCreateAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, OrgCreateAuditEntryBillingPlanGQO billingPlan, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgCreateAuditEntryBillingPlanGQO getBillingPlan() {
        return billingPlan;
    }
    public void setBillingPlan(OrgCreateAuditEntryBillingPlanGQO billingPlan) {
        this.billingPlan = billingPlan;
    }
