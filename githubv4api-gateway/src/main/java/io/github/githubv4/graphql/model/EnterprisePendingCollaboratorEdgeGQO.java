...
public class EnterprisePendingCollaboratorEdgeGQO {
    ...
    public EnterprisePendingCollaboratorEdgeGQO() {
    }

    public EnterprisePendingCollaboratorEdgeGQO(String cursor, Boolean isUnlicensed, UserGQO node, EnterpriseRepositoryInfoConnectionGQO repositories) {
        this.cursor = cursor;
