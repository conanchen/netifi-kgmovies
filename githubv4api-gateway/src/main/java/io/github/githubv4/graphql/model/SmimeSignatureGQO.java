...
public class SmimeSignatureGQO implements GitSignatureGQO{
    ...
    public SmimeSignatureGQO() {
    }

    public SmimeSignatureGQO(String email, Boolean isValid, String payload, String signature, UserGQO signer, GitSignatureStateGQO state, Boolean wasSignedByGitHub) {
        this.email = email;
