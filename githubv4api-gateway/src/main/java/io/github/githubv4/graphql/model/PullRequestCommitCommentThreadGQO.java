...
public class PullRequestCommitCommentThreadGQO implements PullRequestTimelineItemsGQO, NodeGQO, RepositoryNodeGQO{
    ...
    public PullRequestCommitCommentThreadGQO() {
    }

    public PullRequestCommitCommentThreadGQO(CommitCommentConnectionGQO comments, CommitGQO commit, String id, String path, Integer position, PullRequestGQO pullRequest, RepositoryGQO repository) {
