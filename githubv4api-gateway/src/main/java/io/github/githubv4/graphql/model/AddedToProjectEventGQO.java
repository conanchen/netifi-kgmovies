...
public class AddedToProjectEventGQO implements IssueTimelineItemsGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public AddedToProjectEventGQO() {
    }

    public AddedToProjectEventGQO(ActorGQO actor, java.util.Date createdAt, Integer databaseId, String id, ProjectGQO project, ProjectCardGQO projectCard, String projectColumnName) {
        this.actor = actor;
