...
public class ReviewRequestRemovedEventGQO implements PullRequestTimelineItemGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public ReviewRequestRemovedEventGQO() {
    }

    public ReviewRequestRemovedEventGQO(ActorGQO actor, java.util.Date createdAt, String id, PullRequestGQO pullRequest, RequestedReviewerGQO requestedReviewer) {
        this.actor = actor;
