...
public class OrgRemoveOutsideCollaboratorAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private String id;
    @javax.validation.constraints.NotNull
    private Collection<OrgRemoveOutsideCollaboratorAuditEntryMembershipTypeGQO> membershipTypes;
    ...
    private OrgRemoveOutsideCollaboratorAuditEntryReasonGQO reason;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgRemoveOutsideCollaboratorAuditEntryGQO() {
    }

    public OrgRemoveOutsideCollaboratorAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, Collection<OrgRemoveOutsideCollaboratorAuditEntryMembershipTypeGQO> membershipTypes, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgRemoveOutsideCollaboratorAuditEntryReasonGQO reason, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public Collection<OrgRemoveOutsideCollaboratorAuditEntryMembershipTypeGQO> getMembershipTypes() {
        return membershipTypes;
    }
    public void setMembershipTypes(Collection<OrgRemoveOutsideCollaboratorAuditEntryMembershipTypeGQO> membershipTypes) {
        this.membershipTypes = membershipTypes;
    }
    ...
    public OrgRemoveOutsideCollaboratorAuditEntryReasonGQO getReason() {
        return reason;
    }
    public void setReason(OrgRemoveOutsideCollaboratorAuditEntryReasonGQO reason) {
        this.reason = reason;
    }
