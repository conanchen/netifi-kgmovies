...
public class OrgUnblockUserAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private UserGQO blockedUser;
    private String blockedUserName;
    private String blockedUserResourcePath;
    private String blockedUserUrl;
    @javax.validation.constraints.NotNull
    ...
    public OrgUnblockUserAuditEntryGQO() {
    }

    public OrgUnblockUserAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, UserGQO blockedUser, String blockedUserName, String blockedUserResourcePath, String blockedUserUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
        ...
        this.blockedUserResourcePath = blockedUserResourcePath;
        this.blockedUserUrl = blockedUserUrl;
    ...
    public UserGQO getBlockedUser() {
        return blockedUser;
    }
    public void setBlockedUser(UserGQO blockedUser) {
        this.blockedUser = blockedUser;
    }
    ...
    public String getBlockedUserResourcePath() {
        return blockedUserResourcePath;
    }
    public void setBlockedUserResourcePath(String blockedUserResourcePath) {
        this.blockedUserResourcePath = blockedUserResourcePath;
    }

    public String getBlockedUserUrl() {
        return blockedUserUrl;
    }
    public void setBlockedUserUrl(String blockedUserUrl) {
        this.blockedUserUrl = blockedUserUrl;
    }
