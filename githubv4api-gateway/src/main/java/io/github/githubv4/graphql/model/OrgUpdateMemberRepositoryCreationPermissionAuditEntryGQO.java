...
public class OrgUpdateMemberRepositoryCreationPermissionAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private Boolean canCreateRepositories;
    @javax.validation.constraints.NotNull
    ...
    private OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibilityGQO visibility;

    public OrgUpdateMemberRepositoryCreationPermissionAuditEntryGQO() {
    }

    public OrgUpdateMemberRepositoryCreationPermissionAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, Boolean canCreateRepositories, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
        ...
        this.canCreateRepositories = canCreateRepositories;
    ...
    public Boolean getCanCreateRepositories() {
        return canCreateRepositories;
    }
    public void setCanCreateRepositories(Boolean canCreateRepositories) {
        this.canCreateRepositories = canCreateRepositories;
    }
    ...
    public OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
