...
public class RepoChangeMergeSettingAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private RepoChangeMergeSettingAuditEntryMergeTypeGQO mergeType;
    ...
    public RepoChangeMergeSettingAuditEntryGQO() {
    }

    public RepoChangeMergeSettingAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, Boolean isEnabled, RepoChangeMergeSettingAuditEntryMergeTypeGQO mergeType, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoChangeMergeSettingAuditEntryMergeTypeGQO getMergeType() {
        return mergeType;
    }
    public void setMergeType(RepoChangeMergeSettingAuditEntryMergeTypeGQO mergeType) {
        this.mergeType = mergeType;
    }
