...
public class OrgUpdateMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private OrgUpdateMemberAuditEntryPermissionGQO permission;
    private OrgUpdateMemberAuditEntryPermissionGQO permissionWas;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgUpdateMemberAuditEntryGQO() {
    }

    public OrgUpdateMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgUpdateMemberAuditEntryPermissionGQO permission, OrgUpdateMemberAuditEntryPermissionGQO permissionWas, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgUpdateMemberAuditEntryPermissionGQO getPermission() {
        return permission;
    }
    public void setPermission(OrgUpdateMemberAuditEntryPermissionGQO permission) {
        this.permission = permission;
    }

    public OrgUpdateMemberAuditEntryPermissionGQO getPermissionWas() {
        return permissionWas;
    }
    public void setPermissionWas(OrgUpdateMemberAuditEntryPermissionGQO permissionWas) {
        this.permissionWas = permissionWas;
    }
