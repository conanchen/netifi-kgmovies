...
public class RepoDestroyAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private RepoDestroyAuditEntryVisibilityGQO visibility;

    public RepoDestroyAuditEntryGQO() {
    }

    public RepoDestroyAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, RepoDestroyAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoDestroyAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoDestroyAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
