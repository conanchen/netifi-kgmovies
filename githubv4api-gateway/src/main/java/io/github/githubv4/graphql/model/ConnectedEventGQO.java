...
public class ConnectedEventGQO implements IssueTimelineItemsGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public ConnectedEventGQO() {
    }

    public ConnectedEventGQO(ActorGQO actor, java.util.Date createdAt, String id, Boolean isCrossRepository, ReferencedSubjectGQO source, ReferencedSubjectGQO subject) {
        this.actor = actor;
