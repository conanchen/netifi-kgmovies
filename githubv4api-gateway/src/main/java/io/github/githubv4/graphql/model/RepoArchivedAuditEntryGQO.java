...
public class RepoArchivedAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private RepoArchivedAuditEntryVisibilityGQO visibility;

    public RepoArchivedAuditEntryGQO() {
    }

    public RepoArchivedAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, RepoArchivedAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoArchivedAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoArchivedAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
