...
public class CommitCommentGQO implements CommentGQO, DeletableGQO, MinimizableGQO, NodeGQO, ReactableGQO, RepositoryNodeGQO, UpdatableGQO, UpdatableCommentGQO{
    ...
    public CommitCommentGQO() {
    }

    public CommitCommentGQO(ActorGQO author, CommentAuthorAssociationGQO authorAssociation, String body, String bodyHTML, String bodyText, CommitGQO commit, java.util.Date createdAt, Boolean createdViaEmail, Integer databaseId, ActorGQO editor, String id, Boolean includesCreatedEdit, Boolean isMinimized, java.util.Date lastEditedAt, String minimizedReason, String path, Integer position, java.util.Date publishedAt, Collection<ReactionGroupGQO> reactionGroups, ReactionConnectionGQO reactions, RepositoryGQO repository, String resourcePath, java.util.Date updatedAt, String url, UserContentEditConnectionGQO userContentEdits, Boolean viewerCanDelete, Boolean viewerCanMinimize, Boolean viewerCanReact, Boolean viewerCanUpdate, Collection<CommentCannotUpdateReasonGQO> viewerCannotUpdateReasons, Boolean viewerDidAuthor) {
        this.author = author;
