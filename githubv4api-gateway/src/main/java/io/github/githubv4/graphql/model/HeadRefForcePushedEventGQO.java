...
public class HeadRefForcePushedEventGQO implements PullRequestTimelineItemGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public HeadRefForcePushedEventGQO() {
    }

    public HeadRefForcePushedEventGQO(ActorGQO actor, CommitGQO afterCommit, CommitGQO beforeCommit, java.util.Date createdAt, String id, PullRequestGQO pullRequest, RefGQO ref) {
        this.actor = actor;
