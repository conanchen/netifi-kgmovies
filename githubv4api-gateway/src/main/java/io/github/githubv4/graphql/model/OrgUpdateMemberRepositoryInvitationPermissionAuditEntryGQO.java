...
public class OrgUpdateMemberRepositoryInvitationPermissionAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private Boolean canInviteOutsideCollaboratorsToRepositories;
    @javax.validation.constraints.NotNull
    ...
    public OrgUpdateMemberRepositoryInvitationPermissionAuditEntryGQO() {
    }

    public OrgUpdateMemberRepositoryInvitationPermissionAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, Boolean canInviteOutsideCollaboratorsToRepositories, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
        ...
        this.canInviteOutsideCollaboratorsToRepositories = canInviteOutsideCollaboratorsToRepositories;
    ...
    public Boolean getCanInviteOutsideCollaboratorsToRepositories() {
        return canInviteOutsideCollaboratorsToRepositories;
    }
    public void setCanInviteOutsideCollaboratorsToRepositories(Boolean canInviteOutsideCollaboratorsToRepositories) {
        this.canInviteOutsideCollaboratorsToRepositories = canInviteOutsideCollaboratorsToRepositories;
    }
