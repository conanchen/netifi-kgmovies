...
public class OrgInviteMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    public OrgInviteMemberAuditEntryGQO() {
    }

    public OrgInviteMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String email, String id, OperationTypeGQO operationType, OrganizationGQO organization, OrganizationInvitationGQO organizationInvitation, String organizationName, String organizationResourcePath, String organizationUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
