...
public class AddLabelsToLabelableInputGQO {
    ...
    public AddLabelsToLabelableInputGQO() {
    }

    public AddLabelsToLabelableInputGQO(String clientMutationId, Collection<String> labelIds, String labelableId) {
