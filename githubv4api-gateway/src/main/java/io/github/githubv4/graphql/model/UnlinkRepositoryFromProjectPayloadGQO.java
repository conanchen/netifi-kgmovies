...
public class UnlinkRepositoryFromProjectPayloadGQO {

    private String clientMutationId;
    private ProjectGQO project;
    private RepositoryGQO repository;

    public UnlinkRepositoryFromProjectPayloadGQO() {
    }

    public UnlinkRepositoryFromProjectPayloadGQO(String clientMutationId, ProjectGQO project, RepositoryGQO repository) {
