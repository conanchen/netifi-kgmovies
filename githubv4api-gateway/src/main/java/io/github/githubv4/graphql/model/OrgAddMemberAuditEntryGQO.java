...
public class OrgAddMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private OrgAddMemberAuditEntryPermissionGQO permission;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgAddMemberAuditEntryGQO() {
    }

    public OrgAddMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgAddMemberAuditEntryPermissionGQO permission, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgAddMemberAuditEntryPermissionGQO getPermission() {
        return permission;
    }
    public void setPermission(OrgAddMemberAuditEntryPermissionGQO permission) {
        this.permission = permission;
    }
