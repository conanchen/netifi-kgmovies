...
public class OrgRemoveMemberAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO{
    ...
    private String id;
    @javax.validation.constraints.NotNull
    private Collection<OrgRemoveMemberAuditEntryMembershipTypeGQO> membershipTypes;
    ...
    private OrgRemoveMemberAuditEntryReasonGQO reason;
    private UserGQO user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgRemoveMemberAuditEntryGQO() {
    }

    public OrgRemoveMemberAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, Collection<OrgRemoveMemberAuditEntryMembershipTypeGQO> membershipTypes, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgRemoveMemberAuditEntryReasonGQO reason, UserGQO user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public Collection<OrgRemoveMemberAuditEntryMembershipTypeGQO> getMembershipTypes() {
        return membershipTypes;
    }
    public void setMembershipTypes(Collection<OrgRemoveMemberAuditEntryMembershipTypeGQO> membershipTypes) {
        this.membershipTypes = membershipTypes;
    }
    ...
    public OrgRemoveMemberAuditEntryReasonGQO getReason() {
        return reason;
    }
    public void setReason(OrgRemoveMemberAuditEntryReasonGQO reason) {
        this.reason = reason;
    }
