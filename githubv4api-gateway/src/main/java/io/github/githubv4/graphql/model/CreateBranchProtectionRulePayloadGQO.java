...
public class CreateBranchProtectionRulePayloadGQO {

    private BranchProtectionRuleGQO branchProtectionRule;
    private String clientMutationId;

    public CreateBranchProtectionRulePayloadGQO() {
    }

    public CreateBranchProtectionRulePayloadGQO(BranchProtectionRuleGQO branchProtectionRule, String clientMutationId) {
