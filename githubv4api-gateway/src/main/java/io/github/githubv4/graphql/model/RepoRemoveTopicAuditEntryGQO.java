...
public class RepoRemoveTopicAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO, TopicAuditEntryDataGQO{
    ...
    public RepoRemoveTopicAuditEntryGQO() {
    }
