...
public class LabeledEventGQO implements IssueTimelineItemGQO, IssueTimelineItemsGQO, PullRequestTimelineItemGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public LabeledEventGQO() {
    }

    public LabeledEventGQO(ActorGQO actor, java.util.Date createdAt, String id, LabelGQO label, LabelableGQO labelable) {
        this.actor = actor;
