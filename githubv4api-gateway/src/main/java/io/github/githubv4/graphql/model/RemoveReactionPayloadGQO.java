...
public class RemoveReactionPayloadGQO {

    private String clientMutationId;
    private ReactionGQO reaction;
    private ReactableGQO subject;

    public RemoveReactionPayloadGQO() {
    }

    public RemoveReactionPayloadGQO(String clientMutationId, ReactionGQO reaction, ReactableGQO subject) {
