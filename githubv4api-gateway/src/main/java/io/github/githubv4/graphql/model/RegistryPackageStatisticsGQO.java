...
public class RegistryPackageStatisticsGQO {
    ...
    public RegistryPackageStatisticsGQO() {
    }

    public RegistryPackageStatisticsGQO(Integer downloadsThisMonth, Integer downloadsThisWeek, Integer downloadsThisYear, Integer downloadsToday, Integer downloadsTotalCount) {
