...
public class CommitConnectionGQO {
    ...
    public CommitConnectionGQO() {
    }

    public CommitConnectionGQO(Collection<CommitEdgeGQO> edges, Collection<CommitGQO> nodes, PageInfoGQO pageInfo, Integer totalCount) {
        this.edges = edges;
        this.nodes = nodes;
