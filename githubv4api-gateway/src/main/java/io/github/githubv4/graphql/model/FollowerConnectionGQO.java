...
public class FollowerConnectionGQO {
    ...
    public FollowerConnectionGQO() {
    }

    public FollowerConnectionGQO(Collection<UserEdgeGQO> edges, Collection<UserGQO> nodes, PageInfoGQO pageInfo, Integer totalCount) {
        this.edges = edges;
        this.nodes = nodes;
