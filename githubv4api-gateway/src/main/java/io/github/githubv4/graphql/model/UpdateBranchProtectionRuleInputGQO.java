...
public class UpdateBranchProtectionRuleInputGQO {
    ...
    public UpdateBranchProtectionRuleInputGQO() {
    }

    public UpdateBranchProtectionRuleInputGQO(String branchProtectionRuleId, String clientMutationId, Boolean dismissesStaleReviews, Boolean isAdminEnforced, String pattern, Collection<String> pushActorIds, Integer requiredApprovingReviewCount, Collection<String> requiredStatusCheckContexts, Boolean requiresApprovingReviews, Boolean requiresCodeOwnerReviews, Boolean requiresCommitSignatures, Boolean requiresStatusChecks, Boolean requiresStrictStatusChecks, Boolean restrictsPushes, Boolean restrictsReviewDismissals, Collection<String> reviewDismissalActorIds) {
