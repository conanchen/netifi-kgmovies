...
public class CreatedCommitContributionGQO implements ContributionGQO{
    ...
    public CreatedCommitContributionGQO() {
    }

    public CreatedCommitContributionGQO(Integer commitCount, Boolean isRestricted, java.util.Date occurredAt, RepositoryGQO repository, String resourcePath, String url, UserGQO user) {
