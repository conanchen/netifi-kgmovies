...
public class ConvertedNoteToIssueEventGQO implements IssueTimelineItemsGQO, PullRequestTimelineItemsGQO, NodeGQO{
    ...
    public ConvertedNoteToIssueEventGQO() {
    }

    public ConvertedNoteToIssueEventGQO(ActorGQO actor, java.util.Date createdAt, Integer databaseId, String id, ProjectGQO project, ProjectCardGQO projectCard, String projectColumnName) {
        this.actor = actor;
