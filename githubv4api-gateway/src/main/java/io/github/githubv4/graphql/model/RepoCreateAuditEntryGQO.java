...
public class RepoCreateAuditEntryGQO implements OrganizationAuditEntryGQO, AuditEntryGQO, NodeGQO, OrganizationAuditEntryDataGQO, RepositoryAuditEntryDataGQO{
    ...
    private String forkParentName;
    private String forkSourceName;
    @javax.validation.constraints.NotNull
    private String id;
    ...
    private RepoCreateAuditEntryVisibilityGQO visibility;

    public RepoCreateAuditEntryGQO() {
    }

    public RepoCreateAuditEntryGQO(String action, AuditEntryActorGQO actor, String actorIp, ActorLocationGQO actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String forkParentName, String forkSourceName, String id, OperationTypeGQO operationType, OrganizationGQO organization, String organizationName, String organizationResourcePath, String organizationUrl, RepositoryGQO repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, UserGQO user, String userLogin, String userResourcePath, String userUrl, RepoCreateAuditEntryVisibilityGQO visibility) {
        this.action = action;
        this.actor = actor;
        ...
        this.forkParentName = forkParentName;
        this.forkSourceName = forkSourceName;
        this.id = id;
    ...
    public String getForkParentName() {
        return forkParentName;
    }
    public void setForkParentName(String forkParentName) {
        this.forkParentName = forkParentName;
    }

    public String getForkSourceName() {
        return forkSourceName;
    }
    public void setForkSourceName(String forkSourceName) {
        this.forkSourceName = forkSourceName;
    }
    ...
    public RepoCreateAuditEntryVisibilityGQO getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoCreateAuditEntryVisibilityGQO visibility) {
        this.visibility = visibility;
    }
