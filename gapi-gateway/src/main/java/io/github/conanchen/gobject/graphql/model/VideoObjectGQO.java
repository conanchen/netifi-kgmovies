...
public class VideoObjectGQO implements GObjectGQO, NodeGQO {
    ...
    public VideoObjectGQO() {
    }

    public VideoObjectGQO(String name, PersonGQO creator, java.util.Date dateCreated, java.util.Date dateModified, Integer contentSize, java.lang.String contentUrl, String id) {
        this.name = name;
