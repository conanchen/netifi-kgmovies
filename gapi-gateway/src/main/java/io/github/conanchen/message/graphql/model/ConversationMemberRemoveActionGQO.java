...
public class ConversationMemberRemoveActionGQO implements ActionGQO, NodeGQO{
    ...
    public ConversationMemberRemoveActionGQO() {
    }

    public ConversationMemberRemoveActionGQO(Collection<PersonGQO> agent, Collection<PersonGQO> participant, ThingGQO object, EntryPointGQO target, java.util.Date startTime, java.util.Date endTime, PlaceGQO location, String description, String id) {
        this.agent = agent;
