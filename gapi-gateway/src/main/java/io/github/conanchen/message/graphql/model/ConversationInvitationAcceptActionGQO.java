...
public class ConversationInvitationAcceptActionGQO implements ActionGQO, NodeGQO {
    ...
    public ConversationInvitationAcceptActionGQO(Collection<PersonGQO> agent, Collection<PersonGQO> participant, ThingGQO object, java.util.Date startTime, java.util.Date endTime, PlaceGQO location, String description, String id) {
        this.agent = agent;
