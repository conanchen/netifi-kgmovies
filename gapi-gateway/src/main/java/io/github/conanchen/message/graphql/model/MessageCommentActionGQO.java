...
public class MessageCommentActionGQO implements ActionGQO, NodeGQO {
    ...
    public MessageCommentActionGQO(Collection<PersonGQO> agent, Collection<PersonGQO> participant, ThingGQO object, java.util.Date startTime, java.util.Date endTime, PlaceGQO location, String description, String id) {
        this.agent = agent;
