...
public class EmployeeRoleGQO implements NodeGQO {
    ...
    public EmployeeRoleGQO(PersonGQO member, OrgRoleNameGQO roleName, OrganizationGQO hostingOrganization, String membershipNumber, java.util.Date startDate, java.util.Date endDate, java.util.Date createdAt, PersonGQO creator, String id) {
        this.member = member;
