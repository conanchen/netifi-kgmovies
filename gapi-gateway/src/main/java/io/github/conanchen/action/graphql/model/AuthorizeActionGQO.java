...
public class AuthorizeActionGQO implements ActionGQO, NodeGQO {
    ...
    public AuthorizeActionGQO() {
    }

    public AuthorizeActionGQO(Collection<PersonGQO> recipient, Collection<PersonGQO> agent, Collection<PersonGQO> participant, ThingGQO object, EntryPointGQO target, java.util.Date startTime, java.util.Date endTime, PlaceGQO location, String description, String id) {
