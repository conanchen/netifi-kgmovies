...
public class ServiceGQO implements NodeGQO{
    ...
    public ServiceGQO(String name, String alternateName, String description, PlaceGQO areaServed, OpeningHoursSpecificationGQO hoursAvailable, ProductGQO isRelatedTo, ProductGQO isSimilarTo, Collection<ActionUnionGQO> potentialAction, String id) {
        this.name = name;
