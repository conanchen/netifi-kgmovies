...
public class CreateActionGQO implements PotentialActionGQO, ActionGQO, NodeGQO{
    ...
    public CreateActionGQO() {
    }

    public CreateActionGQO(PersonGQO agent, java.util.Date startTime, java.util.Date endTime, PlaceGQO location, MessageGQO object, String description, String id) {
        this.agent = agent;
