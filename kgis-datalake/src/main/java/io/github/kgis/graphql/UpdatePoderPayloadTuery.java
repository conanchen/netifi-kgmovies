...
* 
*/
public class UpdatePoderPayloadTuery extends Tuery<UpdatePoderPayloadTuery> {
    UpdatePoderPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdatePoderPayloadTuery poder(PoderTueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePoderPayloadTuery poder(PoderArgumentsDefinition argsDef, PoderTueryDefinition queryDef) {
        startField("poder");
    ...
    * 
    */
    public UpdatePoderPayloadTuery numUids() {
        startField("numUids");
