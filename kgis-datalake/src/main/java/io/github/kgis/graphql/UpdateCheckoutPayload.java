...
* 
*/
public class UpdateCheckoutPayload extends AbstractResponse<UpdateCheckoutPayload> {
    public UpdateCheckoutPayload() {
    }

    public UpdateCheckoutPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateCheckoutPayload setCheckout(List<Checkout> arg) {
    ...
    */
    ...
    public UpdateCheckoutPayload setNumUids(Integer arg) {
