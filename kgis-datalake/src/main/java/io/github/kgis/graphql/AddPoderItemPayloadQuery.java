...
* 
*/
public class AddPoderItemPayloadQuery extends Query<AddPoderItemPayloadQuery> {
    AddPoderItemPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddPoderItemPayloadQuery poderitem(PoderItemQueryDefinition queryDef) {
    ...
    * 
    */
    public AddPoderItemPayloadQuery poderitem(PoderitemArgumentsDefinition argsDef, PoderItemQueryDefinition queryDef) {
    ...
    * 
    */
    public AddPoderItemPayloadQuery numUids() {
        startField("numUids");
