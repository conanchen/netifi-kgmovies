...
public class CheckoutRef implements Serializable {
    ...
    public CheckoutRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CheckoutRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CheckoutRef setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public CheckoutRef setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutRef setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public CheckoutRef setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CheckoutRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public CheckoutRef setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public CheckoutRef setAlternateNameInput(Input<String> alternateName) {
    ...
    public CheckoutRef setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public CheckoutRef setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutRef setOwner(UserRef owner) {
        this.owner = Input.optional(owner);
        return this;
    }

    public CheckoutRef setOwnerInput(Input<UserRef> owner) {
        if (owner == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.owner = owner;
    ...
    public CheckoutRef setCompletedAt(DateTime completedAt) {
        this.completedAt = Input.optional(completedAt);
        return this;
    }

    public CheckoutRef setCompletedAtInput(Input<DateTime> completedAt) {
        if (completedAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutRef setCreatedAt(DateTime createdAt) {
        this.createdAt = Input.optional(createdAt);
        return this;
    }

    public CheckoutRef setCreatedAtInput(Input<DateTime> createdAt) {
        if (createdAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CheckoutRef setEmail(String email) {
        this.email = Input.optional(email);
        return this;
    }

    public CheckoutRef setEmailInput(Input<String> email) {
        if (email == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.email = email;
    ...
    public CheckoutRef setItems(List<CheckoutItemRef> items) {
        this.items = Input.optional(items);
        return this;
    }

    public CheckoutRef setItemsInput(Input<List<CheckoutItemRef>> items) {
        if (items == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.items = items;
    ...
    public CheckoutRef setNote(String note) {
        this.note = Input.optional(note);
        return this;
    }

    public CheckoutRef setNoteInput(Input<String> note) {
        if (note == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.note = note;
    ...
    public CheckoutRef setReady(Boolean ready) {
        this.ready = Input.optional(ready);
        return this;
    }

    public CheckoutRef setReadyInput(Input<Boolean> ready) {
        if (ready == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.ready = ready;
    ...
    public CheckoutRef setRequiresShipping(Boolean requiresShipping) {
        this.requiresShipping = Input.optional(requiresShipping);
        return this;
    }

    public CheckoutRef setRequiresShippingInput(Input<Boolean> requiresShipping) {
    ...
    public CheckoutRef setUpdatedAt(DateTime updatedAt) {
        this.updatedAt = Input.optional(updatedAt);
        return this;
    }

    public CheckoutRef setUpdatedAtInput(Input<DateTime> updatedAt) {
        if (updatedAt == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
