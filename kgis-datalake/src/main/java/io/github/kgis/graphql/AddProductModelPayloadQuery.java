...
* 
*/
public class AddProductModelPayloadQuery extends Query<AddProductModelPayloadQuery> {
    AddProductModelPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProductModelPayloadQuery productmodel(ProductModelQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductModelPayloadQuery productmodel(ProductmodelArgumentsDefinition argsDef, ProductModelQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductModelPayloadQuery numUids() {
        startField("numUids");
