...
* 
*/
public class AddWebhookPayload extends AbstractResponse<AddWebhookPayload> {
    public AddWebhookPayload() {
    }

    public AddWebhookPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddWebhookPayload setWebhook(List<Webhook> arg) {
    ...
    */
    ...
    public AddWebhookPayload setNumUids(Integer arg) {
