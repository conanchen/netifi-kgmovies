...
* 
*/
public class AddStorePayloadTuery extends Tuery<AddStorePayloadTuery> {
    AddStorePayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddStorePayloadTuery store(StoreTueryDefinition queryDef) {
    ...
    * 
    */
    public AddStorePayloadTuery store(StoreArgumentsDefinition argsDef, StoreTueryDefinition queryDef) {
        startField("store");
    ...
    * 
    */
    public AddStorePayloadTuery numUids() {
        startField("numUids");
