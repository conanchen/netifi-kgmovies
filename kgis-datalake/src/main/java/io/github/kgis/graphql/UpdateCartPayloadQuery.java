...
* 
*/
public class UpdateCartPayloadQuery extends Query<UpdateCartPayloadQuery> {
    UpdateCartPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCartPayloadQuery cart(CartQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCartPayloadQuery cart(CartArgumentsDefinition argsDef, CartQueryDefinition queryDef) {
        startField("cart");
    ...
    * 
    */
    public UpdateCartPayloadQuery numUids() {
        startField("numUids");
