...
* 
*/
public class AddProductPayloadTuery extends Tuery<AddProductPayloadTuery> {
    AddProductPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProductPayloadTuery product(ProductTueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductPayloadTuery product(ProductArgumentsDefinition argsDef, ProductTueryDefinition queryDef) {
        startField("product");
    ...
    * 
    */
    public AddProductPayloadTuery numUids() {
        startField("numUids");
