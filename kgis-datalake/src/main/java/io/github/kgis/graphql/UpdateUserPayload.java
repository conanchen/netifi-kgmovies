...
* 
*/
public class UpdateUserPayload extends AbstractResponse<UpdateUserPayload> {
    public UpdateUserPayload() {
    }

    public UpdateUserPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateUserPayload setUser(List<User> arg) {
    ...
    */
    ...
    public UpdateUserPayload setNumUids(Integer arg) {
