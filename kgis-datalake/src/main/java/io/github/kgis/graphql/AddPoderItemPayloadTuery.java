...
* 
*/
public class AddPoderItemPayloadTuery extends Tuery<AddPoderItemPayloadTuery> {
    AddPoderItemPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddPoderItemPayloadTuery poderitem(PoderItemTueryDefinition queryDef) {
    ...
    * 
    */
    public AddPoderItemPayloadTuery poderitem(PoderitemArgumentsDefinition argsDef, PoderItemTueryDefinition queryDef) {
    ...
    * 
    */
    public AddPoderItemPayloadTuery numUids() {
        startField("numUids");
