...
* 
*/
public class UpdateMessagePayload extends AbstractResponse<UpdateMessagePayload> {
    public UpdateMessagePayload() {
    }

    public UpdateMessagePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateMessagePayload setMessage(List<Message> arg) {
    ...
    */
    ...
    public UpdateMessagePayload setNumUids(Integer arg) {
