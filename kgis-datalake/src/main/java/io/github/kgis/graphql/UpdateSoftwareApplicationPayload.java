...
* 
*/
public class UpdateSoftwareApplicationPayload extends AbstractResponse<UpdateSoftwareApplicationPayload> {
    public UpdateSoftwareApplicationPayload() {
    }

    public UpdateSoftwareApplicationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateSoftwareApplicationPayload";
    }
    ...
    */
    ...
    public UpdateSoftwareApplicationPayload setSoftwareapplication(List<SoftwareApplication> arg) {
    ...
    */
    ...
    public UpdateSoftwareApplicationPayload setNumUids(Integer arg) {
