...
* 
*/
public class AddProductPayloadQuery extends Query<AddProductPayloadQuery> {
    AddProductPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProductPayloadQuery product(ProductQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductPayloadQuery product(ProductArgumentsDefinition argsDef, ProductQueryDefinition queryDef) {
        startField("product");
    ...
    * 
    */
    public AddProductPayloadQuery numUids() {
        startField("numUids");
