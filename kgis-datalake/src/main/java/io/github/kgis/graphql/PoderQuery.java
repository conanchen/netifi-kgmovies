...
*/
public class PoderQuery extends Query<PoderQuery> {
    PoderQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    * 
    */
    public PoderQuery namespaces(NamespaceQueryDefinition queryDef) {
    ...
    * 
    */
    public PoderQuery namespaces(NamespacesArgumentsDefinition argsDef, NamespaceQueryDefinition queryDef) {
    ...
    * 
    */
    public PoderQuery alternateName() {
    ...
    */
    public PoderQuery broker(PartyQueryDefinition queryDef) {
        startField("broker");
    ...
    */
    public PoderQuery customer(PartyQueryDefinition queryDef) {
        startField("customer");
    ...
    */
    public PoderQuery items(PoderItemQueryDefinition queryDef) {
    ...
    * poderedItem    PoderItem  or Product  or Service    The item podered.
    */
    public PoderQuery items(ItemsArgumentsDefinition argsDef, PoderItemQueryDefinition queryDef) {
        startField("items");
    ...
    */
    public PoderQuery seller(OrganizationQueryDefinition queryDef) {
        startField("seller");
