...
* 
*/
public class UpdateEmployeeRolePayloadTuery extends Tuery<UpdateEmployeeRolePayloadTuery> {
    UpdateEmployeeRolePayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateEmployeeRolePayloadTuery employeerole(EmployeeRoleTueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEmployeeRolePayloadTuery employeerole(EmployeeroleArgumentsDefinition argsDef, EmployeeRoleTueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEmployeeRolePayloadTuery numUids() {
        startField("numUids");
