...
* 
*/
public class AddSoftwareApplicationPayloadTuery extends Tuery<AddSoftwareApplicationPayloadTuery> {
    AddSoftwareApplicationPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddSoftwareApplicationPayloadTuery softwareapplication(SoftwareApplicationTueryDefinition queryDef) {
    ...
    * 
    */
    public AddSoftwareApplicationPayloadTuery softwareapplication(SoftwareapplicationArgumentsDefinition argsDef, SoftwareApplicationTueryDefinition queryDef) {
    ...
    * 
    */
    public AddSoftwareApplicationPayloadTuery numUids() {
        startField("numUids");
