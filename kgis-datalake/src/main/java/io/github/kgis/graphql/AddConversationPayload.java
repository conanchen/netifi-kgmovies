...
* 
*/
public class AddConversationPayload extends AbstractResponse<AddConversationPayload> {
    public AddConversationPayload() {
    }

    public AddConversationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddConversationPayload setConversation(List<Conversation> arg) {
    ...
    */
    ...
    public AddConversationPayload setNumUids(Integer arg) {
