...
* 
*/
public class UpdatePoderPayloadQuery extends Query<UpdatePoderPayloadQuery> {
    UpdatePoderPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdatePoderPayloadQuery poder(PoderQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePoderPayloadQuery poder(PoderArgumentsDefinition argsDef, PoderQueryDefinition queryDef) {
        startField("poder");
    ...
    * 
    */
    public UpdatePoderPayloadQuery numUids() {
        startField("numUids");
