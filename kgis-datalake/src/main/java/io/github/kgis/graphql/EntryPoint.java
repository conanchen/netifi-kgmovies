...
public class EntryPoint extends AbstractResponse<EntryPoint> implements Node, Thing {
    ...
    public EntryPoint(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public EntryPoint setNamespaces(List<Namespace> arg) {
    ...
    */
    ...
    public EntryPoint setIdentifier(String arg) {
    ...
    */
    ...
    public EntryPoint setName(String arg) {
    ...
    */
    ...
    public EntryPoint setAlternateName(String arg) {
    ...
    */
    ...
    public EntryPoint setDescription(String arg) {
    ...
    */
    ...
    public String getUrlTemplate() {
        return (String) get("urlTemplate");
    }

    public EntryPoint setUrlTemplate(String arg) {
        optimisticData.put(getKey("urlTemplate"), arg);
        return this;
    }
