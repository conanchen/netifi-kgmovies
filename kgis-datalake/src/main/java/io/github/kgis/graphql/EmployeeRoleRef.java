...
public class EmployeeRoleRef implements Serializable {
    ...
    public EmployeeRoleRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public EmployeeRoleRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public EmployeeRoleRef setPerson(PersonRef person) {
        this.person = Input.optional(person);
        return this;
    }

    public EmployeeRoleRef setPersonInput(Input<PersonRef> person) {
        if (person == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.person = person;
    ...
    public EmployeeRoleRef setRoleName(PartyRoleNameRef roleName) {
        this.roleName = Input.optional(roleName);
        return this;
    }

    public EmployeeRoleRef setRoleNameInput(Input<PartyRoleNameRef> roleName) {
        if (roleName == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setDateFrom(DateTime dateFrom) {
        this.dateFrom = Input.optional(dateFrom);
        return this;
    }

    public EmployeeRoleRef setDateFromInput(Input<DateTime> dateFrom) {
        if (dateFrom == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setDateThrough(DateTime dateThrough) {
        this.dateThrough = Input.optional(dateThrough);
        return this;
    }

    public EmployeeRoleRef setDateThroughInput(Input<DateTime> dateThrough) {
        if (dateThrough == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public EmployeeRoleRef setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public EmployeeRoleRef setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public EmployeeRoleRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public EmployeeRoleRef setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public EmployeeRoleRef setAlternateNameInput(Input<String> alternateName) {
    ...
    public EmployeeRoleRef setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public EmployeeRoleRef setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public EmployeeRoleRef setNumber(String number) {
        this.number = Input.optional(number);
        return this;
    }

    public EmployeeRoleRef setNumberInput(Input<String> number) {
        if (number == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.number = number;
