...
* 
*/
public class AddStorePayloadQuery extends Query<AddStorePayloadQuery> {
    AddStorePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddStorePayloadQuery store(StoreQueryDefinition queryDef) {
    ...
    * 
    */
    public AddStorePayloadQuery store(StoreArgumentsDefinition argsDef, StoreQueryDefinition queryDef) {
        startField("store");
    ...
    * 
    */
    public AddStorePayloadQuery numUids() {
        startField("numUids");
