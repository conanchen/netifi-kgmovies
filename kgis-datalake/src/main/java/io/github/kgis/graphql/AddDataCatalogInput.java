...
public class AddDataCatalogInput implements Serializable {
    private String name;
    ...
    public AddDataCatalogInput(String name) {
        this.name = name;
    }
    ...
    public AddDataCatalogInput setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AddDataCatalogInput setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public AddDataCatalogInput setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
    ...
    public AddDataCatalogInput setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public AddDataCatalogInput setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddDataCatalogInput setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public AddDataCatalogInput setAlternateNameInput(Input<String> alternateName) {
    ...
    public AddDataCatalogInput setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public AddDataCatalogInput setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddDataCatalogInput setParentDataCatalog(DataCatalogRef parentDataCatalog) {
        this.parentDataCatalog = Input.optional(parentDataCatalog);
        return this;
    }

    public AddDataCatalogInput setParentDataCatalogInput(Input<DataCatalogRef> parentDataCatalog) {
    ...
    public AddDataCatalogInput setSubDataCatalogs(List<DataCatalogRef> subDataCatalogs) {
        this.subDataCatalogs = Input.optional(subDataCatalogs);
        return this;
    }

    public AddDataCatalogInput setSubDataCatalogsInput(Input<List<DataCatalogRef>> subDataCatalogs) {
    ...
    public AddDataCatalogInput setCreator(UserRef creator) {
        this.creator = Input.optional(creator);
        return this;
    }

    public AddDataCatalogInput setCreatorInput(Input<UserRef> creator) {
        if (creator == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddDataCatalogInput setDateCreated(DateTime dateCreated) {
        this.dateCreated = Input.optional(dateCreated);
        return this;
    }

    public AddDataCatalogInput setDateCreatedInput(Input<DateTime> dateCreated) {
        if (dateCreated == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
