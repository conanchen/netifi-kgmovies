...
* 
*/
public class UpdatePoderItemPayload extends AbstractResponse<UpdatePoderItemPayload> {
    public UpdatePoderItemPayload() {
    }

    public UpdatePoderItemPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdatePoderItemPayload setPoderitem(List<PoderItem> arg) {
    ...
    */
    ...
    public UpdatePoderItemPayload setNumUids(Integer arg) {
