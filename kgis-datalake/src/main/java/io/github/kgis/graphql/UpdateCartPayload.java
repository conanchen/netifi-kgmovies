...
* 
*/
public class UpdateCartPayload extends AbstractResponse<UpdateCartPayload> {
    public UpdateCartPayload() {
    }

    public UpdateCartPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateCartPayload setCart(List<Cart> arg) {
    ...
    */
    ...
    public UpdateCartPayload setNumUids(Integer arg) {
