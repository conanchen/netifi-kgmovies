...
public class GeneralOrganizationRef implements Serializable {
    ...
    public GeneralOrganizationRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public GeneralOrganizationRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public GeneralOrganizationRef setOwns(List<OwnershipRef> owns) {
        this.owns = Input.optional(owns);
        return this;
    }

    public GeneralOrganizationRef setOwnsInput(Input<List<OwnershipRef>> owns) {
        if (owns == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.owns = owns;
    ...
    public GeneralOrganizationRef setHasNamespaces(List<NamespaceRef> hasNamespaces) {
        this.hasNamespaces = Input.optional(hasNamespaces);
        return this;
    }

    public GeneralOrganizationRef setHasNamespacesInput(Input<List<NamespaceRef>> hasNamespaces) {
    ...
    public GeneralOrganizationRef setHasPartyRoleName(List<PartyRoleNameRef> hasPartyRoleName) {
        this.hasPartyRoleName = Input.optional(hasPartyRoleName);
        return this;
    }

    public GeneralOrganizationRef setHasPartyRoleNameInput(Input<List<PartyRoleNameRef>> hasPartyRoleName) {
    ...
    public GeneralOrganizationRef setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public GeneralOrganizationRef setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public GeneralOrganizationRef setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public GeneralOrganizationRef setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public GeneralOrganizationRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public GeneralOrganizationRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public GeneralOrganizationRef setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public GeneralOrganizationRef setAlternateNameInput(Input<String> alternateName) {
    ...
    public GeneralOrganizationRef setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public GeneralOrganizationRef setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public GeneralOrganizationRef setAvailableConversations(List<ConversationRef> availableConversations) {
        this.availableConversations = Input.optional(availableConversations);
        return this;
    }

    public GeneralOrganizationRef setAvailableConversationsInput(Input<List<ConversationRef>> availableConversations) {
    ...
    public GeneralOrganizationRef setDefaultConversation(ConversationRef defaultConversation) {
        this.defaultConversation = Input.optional(defaultConversation);
        return this;
    }

    public GeneralOrganizationRef setDefaultConversationInput(Input<ConversationRef> defaultConversation) {
