...
* 
*/
public class UpdatePartyRoleNamePayloadQuery extends Query<UpdatePartyRoleNamePayloadQuery> {
    UpdatePartyRoleNamePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdatePartyRoleNamePayloadQuery partyrolename(PartyRoleNameQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePartyRoleNamePayloadQuery partyrolename(PartyrolenameArgumentsDefinition argsDef, PartyRoleNameQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePartyRoleNamePayloadQuery numUids() {
        startField("numUids");
