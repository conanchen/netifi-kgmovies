...
* 
*/
public class AddGeneralOrganizationPayload extends AbstractResponse<AddGeneralOrganizationPayload> {
    public AddGeneralOrganizationPayload() {
    }

    public AddGeneralOrganizationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddGeneralOrganizationPayload";
    }
    ...
    */
    ...
    public AddGeneralOrganizationPayload setGeneralorganization(List<GeneralOrganization> arg) {
    ...
    */
    ...
    public AddGeneralOrganizationPayload setNumUids(Integer arg) {
