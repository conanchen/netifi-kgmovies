...
* 
*/
public class AddReviewPayloadQuery extends Query<AddReviewPayloadQuery> {
    AddReviewPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddReviewPayloadQuery review(ReviewQueryDefinition queryDef) {
    ...
    * 
    */
    public AddReviewPayloadQuery review(ReviewArgumentsDefinition argsDef, ReviewQueryDefinition queryDef) {
        startField("review");
    ...
    * 
    */
    public AddReviewPayloadQuery numUids() {
        startField("numUids");
