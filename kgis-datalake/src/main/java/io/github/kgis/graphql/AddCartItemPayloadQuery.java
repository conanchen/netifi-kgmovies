...
* 
*/
public class AddCartItemPayloadQuery extends Query<AddCartItemPayloadQuery> {
    AddCartItemPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCartItemPayloadQuery cartitem(CartItemQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCartItemPayloadQuery cartitem(CartitemArgumentsDefinition argsDef, CartItemQueryDefinition queryDef) {
        startField("cartitem");
    ...
    * 
    */
    public AddCartItemPayloadQuery numUids() {
        startField("numUids");
