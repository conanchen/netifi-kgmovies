...
public class OfferRef implements Serializable {
    ...
    public OfferRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public OfferRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public OfferRef setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public OfferRef setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public OfferRef setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public OfferRef setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public OfferRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public OfferRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public OfferRef setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public OfferRef setAlternateNameInput(Input<String> alternateName) {
    ...
    public OfferRef setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public OfferRef setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public OfferRef setPrice(Integer price) {
        this.price = Input.optional(price);
        return this;
    }

    public OfferRef setPriceInput(Input<Integer> price) {
        if (price == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.price = price;
    ...
    public OfferRef setDateFrom(DateTime dateFrom) {
        this.dateFrom = Input.optional(dateFrom);
        return this;
    }

    public OfferRef setDateFromInput(Input<DateTime> dateFrom) {
        if (dateFrom == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public OfferRef setDateThrough(DateTime dateThrough) {
        this.dateThrough = Input.optional(dateThrough);
        return this;
    }

    public OfferRef setDateThroughInput(Input<DateTime> dateThrough) {
        if (dateThrough == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
