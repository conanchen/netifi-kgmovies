...
public class MemberRolePatch implements Serializable {
    ...
    public MemberRolePatch setPerson(PersonRef person) {
        this.person = Input.optional(person);
        return this;
    }

    public MemberRolePatch setPersonInput(Input<PersonRef> person) {
        if (person == null) {
    ...
    public MemberRolePatch setRoleName(PartyRoleNameRef roleName) {
        this.roleName = Input.optional(roleName);
        return this;
    }

    public MemberRolePatch setRoleNameInput(Input<PartyRoleNameRef> roleName) {
        if (roleName == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setDateFrom(DateTime dateFrom) {
        this.dateFrom = Input.optional(dateFrom);
        return this;
    }

    public MemberRolePatch setDateFromInput(Input<DateTime> dateFrom) {
        if (dateFrom == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setDateThrough(DateTime dateThrough) {
        this.dateThrough = Input.optional(dateThrough);
        return this;
    }

    public MemberRolePatch setDateThroughInput(Input<DateTime> dateThrough) {
        if (dateThrough == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public MemberRolePatch setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public MemberRolePatch setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public MemberRolePatch setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public MemberRolePatch setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public MemberRolePatch setAlternateNameInput(Input<String> alternateName) {
    ...
    public MemberRolePatch setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public MemberRolePatch setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public MemberRolePatch setNumber(String number) {
        this.number = Input.optional(number);
        return this;
    }

    public MemberRolePatch setNumberInput(Input<String> number) {
        if (number == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.number = number;
