...
* 
*/
public class UpdateEntryPointPayloadTuery extends Tuery<UpdateEntryPointPayloadTuery> {
    UpdateEntryPointPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateEntryPointPayloadTuery entrypoint(EntryPointTueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEntryPointPayloadTuery entrypoint(EntrypointArgumentsDefinition argsDef, EntryPointTueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEntryPointPayloadTuery numUids() {
        startField("numUids");
