...
* 
*/
public class UpdateReadNotePayloadQuery extends Query<UpdateReadNotePayloadQuery> {
    UpdateReadNotePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateReadNotePayloadQuery readnote(ReadNoteQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateReadNotePayloadQuery readnote(ReadnoteArgumentsDefinition argsDef, ReadNoteQueryDefinition queryDef) {
        startField("readnote");
    ...
    * 
    */
    public UpdateReadNotePayloadQuery numUids() {
        startField("numUids");
