...
* 
*/
public class AddMemberRolePayload extends AbstractResponse<AddMemberRolePayload> {
    public AddMemberRolePayload() {
    }

    public AddMemberRolePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddMemberRolePayload setMemberrole(List<MemberRole> arg) {
    ...
    */
    ...
    public AddMemberRolePayload setNumUids(Integer arg) {
