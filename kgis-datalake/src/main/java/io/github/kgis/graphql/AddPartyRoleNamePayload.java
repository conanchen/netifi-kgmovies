...
* 
*/
public class AddPartyRoleNamePayload extends AbstractResponse<AddPartyRoleNamePayload> {
    public AddPartyRoleNamePayload() {
    }

    public AddPartyRoleNamePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddPartyRoleNamePayload";
    }
    ...
    */
    ...
    public AddPartyRoleNamePayload setPartyrolename(List<PartyRoleName> arg) {
    ...
    */
    ...
    public AddPartyRoleNamePayload setNumUids(Integer arg) {
