...
* 
*/
public class AddCheckoutPayloadQuery extends Query<AddCheckoutPayloadQuery> {
    AddCheckoutPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCheckoutPayloadQuery checkout(CheckoutQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCheckoutPayloadQuery checkout(CheckoutArgumentsDefinition argsDef, CheckoutQueryDefinition queryDef) {
        startField("checkout");
    ...
    * 
    */
    public AddCheckoutPayloadQuery numUids() {
        startField("numUids");
