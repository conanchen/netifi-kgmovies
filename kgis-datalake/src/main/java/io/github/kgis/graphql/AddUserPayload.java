...
* 
*/
public class AddUserPayload extends AbstractResponse<AddUserPayload> {
    public AddUserPayload() {
    }

    public AddUserPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddUserPayload setUser(List<User> arg) {
    ...
    */
    ...
    public AddUserPayload setNumUids(Integer arg) {
