...
* 
*/
public class UpdateProductPayload extends AbstractResponse<UpdateProductPayload> {
    public UpdateProductPayload() {
    }

    public UpdateProductPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateProductPayload setProduct(List<Product> arg) {
    ...
    */
    ...
    public UpdateProductPayload setNumUids(Integer arg) {
