...
* 
*/
public class UpdateProductModelPayload extends AbstractResponse<UpdateProductModelPayload> {
    public UpdateProductModelPayload() {
    }

    public UpdateProductModelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateProductModelPayload";
    }
    ...
    */
    ...
    public UpdateProductModelPayload setProductmodel(List<ProductModel> arg) {
    ...
    */
    ...
    public UpdateProductModelPayload setNumUids(Integer arg) {
