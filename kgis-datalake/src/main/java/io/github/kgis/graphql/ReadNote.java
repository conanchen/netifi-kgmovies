...
public class ReadNote extends AbstractResponse<ReadNote> implements Node, Thing {
    ...
    public ReadNote(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public ReadNote setNamespaces(List<Namespace> arg) {
    ...
    */
    ...
    public ReadNote setIdentifier(String arg) {
    ...
    */
    ...
    public ReadNote setName(String arg) {
    ...
    */
    ...
    public ReadNote setAlternateName(String arg) {
    ...
    */
    ...
    public ReadNote setDescription(String arg) {
    ...
    */
    ...
    public List<Readable> getIsReadNoteOf() {
        return (List<Readable>) get("isReadNoteOf");
    }

    public ReadNote setIsReadNoteOf(List<Readable> arg) {
        optimisticData.put(getKey("isReadNoteOf"), arg);
        return this;
    }
    ...
    */
    ...
    public User getReader() {
        return (User) get("reader");
    }

    public ReadNote setReader(User arg) {
        optimisticData.put(getKey("reader"), arg);
        return this;
    }
    ...
    */
    ...
    public ReadNote setDateRead(DateTime arg) {
