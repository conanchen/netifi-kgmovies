...
* 
*/
public class AddConversationPayloadTuery extends Tuery<AddConversationPayloadTuery> {
    AddConversationPayloadTuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddConversationPayloadTuery conversation(ConversationTueryDefinition queryDef) {
    ...
    * 
    */
    public AddConversationPayloadTuery conversation(ConversationArgumentsDefinition argsDef, ConversationTueryDefinition queryDef) {
    ...
    * 
    */
    public AddConversationPayloadTuery numUids() {
        startField("numUids");
