...
* 
*/
public class UpdateEntryPointPayload extends AbstractResponse<UpdateEntryPointPayload> {
    public UpdateEntryPointPayload() {
    }

    public UpdateEntryPointPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateEntryPointPayload";
    }
    ...
    */
    ...
    public UpdateEntryPointPayload setEntrypoint(List<EntryPoint> arg) {
    ...
    */
    ...
    public UpdateEntryPointPayload setNumUids(Integer arg) {
