...
* 
*/
public class UpdateCheckoutItemPayloadQuery extends Query<UpdateCheckoutItemPayloadQuery> {
    UpdateCheckoutItemPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCheckoutItemPayloadQuery checkoutitem(CheckoutItemQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCheckoutItemPayloadQuery checkoutitem(CheckoutitemArgumentsDefinition argsDef, CheckoutItemQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCheckoutItemPayloadQuery numUids() {
        startField("numUids");
