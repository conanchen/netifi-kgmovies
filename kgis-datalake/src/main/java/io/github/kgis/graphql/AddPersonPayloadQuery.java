...
* 
*/
public class AddPersonPayloadQuery extends Query<AddPersonPayloadQuery> {
    AddPersonPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddPersonPayloadQuery person(PersonQueryDefinition queryDef) {
    ...
    * 
    */
    public AddPersonPayloadQuery person(PersonArgumentsDefinition argsDef, PersonQueryDefinition queryDef) {
        startField("person");
    ...
    * 
    */
    public AddPersonPayloadQuery numUids() {
        startField("numUids");
