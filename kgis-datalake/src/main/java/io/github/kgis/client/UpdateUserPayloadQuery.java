...
* 
*/
public class UpdateUserPayloadQuery extends Query<UpdateUserPayloadQuery> {
    UpdateUserPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateUserPayloadQuery user(UserQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateUserPayloadQuery user(UserArgumentsDefinition argsDef, UserQueryDefinition queryDef) {
        startField("user");
    ...
    * 
    */
    public UpdateUserPayloadQuery numUids() {
        startField("numUids");
