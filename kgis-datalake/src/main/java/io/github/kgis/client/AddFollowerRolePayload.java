...
* 
*/
public class AddFollowerRolePayload extends AbstractResponse<AddFollowerRolePayload> {
    public AddFollowerRolePayload() {
    }

    public AddFollowerRolePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddFollowerRolePayload setFollowerrole(List<FollowerRole> arg) {
    ...
    */
    ...
    public AddFollowerRolePayload setNumUids(Integer arg) {
