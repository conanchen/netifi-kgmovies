...
* 
*/
public class AddConversationPayloadQuery extends Query<AddConversationPayloadQuery> {
    AddConversationPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddConversationPayloadQuery conversation(ConversationQueryDefinition queryDef) {
    ...
    * 
    */
    public AddConversationPayloadQuery conversation(ConversationArgumentsDefinition argsDef, ConversationQueryDefinition queryDef) {
    ...
    * 
    */
    public AddConversationPayloadQuery numUids() {
        startField("numUids");
