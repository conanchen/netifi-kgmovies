...
* 
*/
public class UpdateDataCatalogPayload extends AbstractResponse<UpdateDataCatalogPayload> {
    public UpdateDataCatalogPayload() {
    }

    public UpdateDataCatalogPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateDataCatalogPayload";
    }
    ...
    */
    ...
    public UpdateDataCatalogPayload setDatacatalog(List<DataCatalog> arg) {
    ...
    */
    ...
    public UpdateDataCatalogPayload setNumUids(Integer arg) {
