...
* 
*/
public class UpdateSoftwareApplicationPayloadQuery extends Query<UpdateSoftwareApplicationPayloadQuery> {
    UpdateSoftwareApplicationPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateSoftwareApplicationPayloadQuery softwareapplication(SoftwareApplicationQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateSoftwareApplicationPayloadQuery softwareapplication(SoftwareapplicationArgumentsDefinition argsDef, SoftwareApplicationQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateSoftwareApplicationPayloadQuery numUids() {
        startField("numUids");
