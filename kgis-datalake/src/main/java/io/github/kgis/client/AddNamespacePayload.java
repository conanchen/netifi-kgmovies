...
* 
*/
public class AddNamespacePayload extends AbstractResponse<AddNamespacePayload> {
    public AddNamespacePayload() {
    }

    public AddNamespacePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddNamespacePayload setNamespace(List<Namespace> arg) {
    ...
    */
    ...
    public AddNamespacePayload setNumUids(Integer arg) {
