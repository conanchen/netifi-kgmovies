...
* 
*/
public class UpdateWebhookPayload extends AbstractResponse<UpdateWebhookPayload> {
    public UpdateWebhookPayload() {
    }

    public UpdateWebhookPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateWebhookPayload setWebhook(List<Webhook> arg) {
    ...
    */
    ...
    public UpdateWebhookPayload setNumUids(Integer arg) {
