...
* 
*/
public class AddOfferPayloadQuery extends Query<AddOfferPayloadQuery> {
    AddOfferPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddOfferPayloadQuery offer(OfferQueryDefinition queryDef) {
    ...
    * 
    */
    public AddOfferPayloadQuery offer(OfferArgumentsDefinition argsDef, OfferQueryDefinition queryDef) {
        startField("offer");
    ...
    * 
    */
    public AddOfferPayloadQuery numUids() {
        startField("numUids");
