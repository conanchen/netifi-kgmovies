...
* 
*/
public class UpdateDataCatalogPayloadQuery extends Query<UpdateDataCatalogPayloadQuery> {
    UpdateDataCatalogPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateDataCatalogPayloadQuery datacatalog(DataCatalogQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateDataCatalogPayloadQuery datacatalog(DatacatalogArgumentsDefinition argsDef, DataCatalogQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateDataCatalogPayloadQuery numUids() {
        startField("numUids");
