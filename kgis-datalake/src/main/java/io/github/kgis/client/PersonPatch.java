...
public class PersonPatch implements Serializable {
    ...
    public PersonPatch setNamespaces(List<NamespaceRef> namespaces) {
        this.namespaces = Input.optional(namespaces);
        return this;
    }

    public PersonPatch setNamespacesInput(Input<List<NamespaceRef>> namespaces) {
        if (namespaces == null) {
    ...
    public PersonPatch setIdentifier(String identifier) {
        this.identifier = Input.optional(identifier);
        return this;
    }

    public PersonPatch setIdentifierInput(Input<String> identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public PersonPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public PersonPatch setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public PersonPatch setAlternateName(String alternateName) {
        this.alternateName = Input.optional(alternateName);
        return this;
    }

    public PersonPatch setAlternateNameInput(Input<String> alternateName) {
    ...
    public PersonPatch setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public PersonPatch setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public PersonPatch setOwns(List<OwnershipRef> owns) {
        this.owns = Input.optional(owns);
        return this;
    }

    public PersonPatch setOwnsInput(Input<List<OwnershipRef>> owns) {
        if (owns == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.owns = owns;
    ...
    public PersonPatch setHasNamespaces(List<NamespaceRef> hasNamespaces) {
        this.hasNamespaces = Input.optional(hasNamespaces);
        return this;
    }

    public PersonPatch setHasNamespacesInput(Input<List<NamespaceRef>> hasNamespaces) {
    ...
    public PersonPatch setPersonalId(String personalId) {
        this.personalId = Input.optional(personalId);
        return this;
    }

    public PersonPatch setPersonalIdInput(Input<String> personalId) {
        if (personalId == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public PersonPatch setFamilyName(String familyName) {
        this.familyName = Input.optional(familyName);
        return this;
    }

    public PersonPatch setFamilyNameInput(Input<String> familyName) {
        if (familyName == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public PersonPatch setGivenName(String givenName) {
        this.givenName = Input.optional(givenName);
        return this;
    }

    public PersonPatch setGivenNameInput(Input<String> givenName) {
        if (givenName == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public PersonPatch setHasUser(UserRef hasUser) {
        this.hasUser = Input.optional(hasUser);
        return this;
    }

    public PersonPatch setHasUserInput(Input<UserRef> hasUser) {
        if (hasUser == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public void appendTo(StringBuilder _queryBuilder) {
        ...
        if (this.personalId.isDefined()) {
            ...
            if (personalId.getValue() != null) {
                Query.appendQuotedString(_queryBuilder, personalId.getValue().toString());
            } else {
                _queryBuilder.append("null");
            }
        }
        ...
        if (this.familyName.isDefined()) {
            ...
            if (familyName.getValue() != null) {
                Query.appendQuotedString(_queryBuilder, familyName.getValue().toString());
            } else {
                _queryBuilder.append("null");
            }
        }
        ...
        if (this.givenName.isDefined()) {
            ...
            if (givenName.getValue() != null) {
                Query.appendQuotedString(_queryBuilder, givenName.getValue().toString());
            } else {
                _queryBuilder.append("null");
            }
        }
