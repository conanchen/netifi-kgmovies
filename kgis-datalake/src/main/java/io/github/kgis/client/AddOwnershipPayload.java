...
* 
*/
public class AddOwnershipPayload extends AbstractResponse<AddOwnershipPayload> {
    public AddOwnershipPayload() {
    }

    public AddOwnershipPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddOwnershipPayload setOwnership(List<Ownership> arg) {
    ...
    */
    ...
    public AddOwnershipPayload setNumUids(Integer arg) {
