...
* 
*/
public class UpdateEntryPointPayloadQuery extends Query<UpdateEntryPointPayloadQuery> {
    UpdateEntryPointPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateEntryPointPayloadQuery entrypoint(EntryPointQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEntryPointPayloadQuery entrypoint(EntrypointArgumentsDefinition argsDef, EntryPointQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEntryPointPayloadQuery numUids() {
        startField("numUids");
