...
* 
*/
public class UpdateOwnershipPayloadQuery extends Query<UpdateOwnershipPayloadQuery> {
    UpdateOwnershipPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateOwnershipPayloadQuery ownership(OwnershipQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateOwnershipPayloadQuery ownership(OwnershipArgumentsDefinition argsDef, OwnershipQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateOwnershipPayloadQuery numUids() {
        startField("numUids");
