...
public class IntegrationTest {
    ...
    @Test
    public void testOptionalArgTuery() throws Exception {
    ...
    @Test
    public void testInterfaceTuery() throws Exception {
    ...
    @Test
    public void testUnionTuery() throws Exception {
        String queryString = Generated.query(query ->
    ...
    public void testStringFieldResponse() throws Exception {
        ...
        GeneratedMinimal.TueryRoot data = GeneratedMinimal.TueryResponse.fromJson(json).getData();
    ...
    public void testStringListResponse() throws Exception {
        ...
        Generated.TueryRoot data = Generated.TueryResponse.fromJson(json).getData();
    ...
    public void testInterfaceResponse() throws Exception {
        ...
        Generated.Entry entry = Generated.TueryResponse.fromJson(json).getData().getEntry();
    ...
    public void testUnionResponse() throws Exception {
        ...
        Generated.EntryUnion entry = Generated.TueryResponse.fromJson(json).getData().getEntryUnion();
        assertEquals("IntegerEntry", entry.getGraphQlTypeName());
        assertTrue(entry instanceof Generated.IntegerEntry);
        assertEquals(42, ((Generated.IntegerEntry) entry).getValue().intValue());
    }
